 ...
 */
package com.example.flutter_geofencing.geofencing
...
import com.example.flutter_geofencing.FlutterGeofencingPlugin
...
//        val notificationIntent = Intent(applicationContext, FlutterGeofencingPlugin::class.java)
////
////
////
////        // Add the main Activity to the task stack as the parent.
//        stackBuilder.addParentStack(FlutterGeofencingPlugin::class.java)
////
...
//        }
        ...
        if (iconResourceId!=null){
            builder.setSmallIcon(iconResourceId!!) // In a real app, you may want to use a library like Volley
